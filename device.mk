...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/halium-overlay/usr/lib/systemd/system/ofono.service.d/.halium-overlay-dir:$(TARGET_COPY_OUT_SYSTEM)/halium/usr/lib/systemd/system/ofono.service.d/.halium-overlay-dir \
    $(LOCAL_PATH)/halium-overlay/usr/lib/systemd/system/ofono.service.d/wait-for-ril.conf:$(TARGET_COPY_OUT_SYSTEM)/halium/usr/lib/systemd/system/ofono.service.d/wait-for-ril.conf \
